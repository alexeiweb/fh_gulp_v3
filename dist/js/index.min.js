...
"use strict";document.addEventListener("click",(function(e){e.target.matches("button")&&e.target.focus()}));var heroBtn=document.querySelector(".hero__btn"),overlay=document.querySelector(".overlay"),modal=document.querySelector(".modal");heroBtn.addEventListener("click",(function(){overlay.classList.add("overlay_active"),modal.classList.add("modal_active")})),overlay.addEventListener("click",(function(e){var t=e.target;(t===overlay||t.closest(".modal__close"))&&(overlay.classList.remove("overlay_active"),modal.classList.remove("modal_active"))})),modal.click((function(e){modalContent.is(e.target)||0!==modalContent.has(e.target).length||($(this).removeClass("modal_active"),modalOverlay.removeClass("overlay_active"))}));var modalTitle=$(".modal__title"),modalForm=$(".modal__form");modalForm.submit((function(e){e.preventDefault(),$.ajax({url:"https://jsonplaceholder.typicode.com/posts",type:"POST",data:$(this).serialize(),success:function(e){modalTitle.text("Спасибо, ожидайте звонок"),modalForm.slideUp(300)},error:function(){modalTitle.text("Косячок")}})}));var burger=document.querySelector(".header__burger"),popup=document.querySelector(".popup"),headerNav=document.querySelector(".burger__menu");burger.addEventListener("click",(function(){popup.classList.add("active"),headerNav.classList.add("active")})),$(".burger__menu_item a").on("click",(function(){$(".burger__menu").removeClass("active"),$(".popup").removeClass("active")})),new Swiper(".swiper",{loop:!0,navigation:{nextEl:".feedback__arrow_right",prevEl:".feedback__arrow_left"}});